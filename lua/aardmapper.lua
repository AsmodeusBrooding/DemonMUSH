...
local default_config = {
   -- assorted colours
   OUR_ROOM_COLOUR         = { name = "Room",             colour =  ColourNameToRGB "red"},
   SHOP_FILL_COLOUR         = { name = "Shop Colour",             colour =  ColourNameToRGB "cyan"},
   BACKGROUND_COLOUR       = { name = "Area Background",   colour =  ColourNameToRGB "lightseagreen", },
   ROOM_COLOUR             = { name = "Room",              colour =  ColourNameToRGB "darkviolet", },
   EXIT_COLOUR             = { name = "Exit",              colour =  ColourNameToRGB "white", },
   ...
   -- size of map window
   WINDOW = { width = GetVariable("width") or 400, height = GetVariable("height") or 400 },
